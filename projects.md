...
*RStudio · Power BI · Python · Data Visualization*  
Built an interactive BI dashboard analyzing the three pillars of the Energy Trilemma — **affordability, accessibility, and sustainability** — using household survey datasets.  
Cleaned and transformed data using Python and R, and developed custom indicators to compare energy impacts across regions.

🔗 **Links:**  
- [Power BI Dashboard – Visual Report](https://drive.google.com/file/d/1cDYJW90n8qgGQMIEOMaaMUpdloebSJns/view?usp=sharing)  
- [Insights & Findings – Presentation](https://docs.google.com/presentation/d/19jYETgIwTtHlWDKL_qDlswsKFyVxvyLI/edit?usp=sharing&ouid=117105990485077395410&rtpof=true&sd=true)

---

### **JTI Business Analytics Dashboard**  
...
🔗 **Links:**  
- [GitHub Repository](https://github.com/CMPUT301F25spider/event-app.git)  
